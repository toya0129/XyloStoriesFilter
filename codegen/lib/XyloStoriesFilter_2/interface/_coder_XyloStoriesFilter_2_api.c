 ...
 *
 * _coder_XyloStoriesFilter_2_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "XyloStoriesFilter_2",               /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void XyloStoriesFilter_2_api(const mxArray * const prhs[1], int32_T nlhs, const
  mxArray *plhs[1])
{
  ...
  out = XyloStoriesFilter_2(*inputData);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(out);
}

void XyloStoriesFilter_2_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  XyloStoriesFilter_2_xil_terminate();
}

void XyloStoriesFilter_2_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void XyloStoriesFilter_2_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_XyloStoriesFilter_2_api.c) */
