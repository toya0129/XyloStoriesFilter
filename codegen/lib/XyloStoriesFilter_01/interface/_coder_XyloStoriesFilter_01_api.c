 ...
 *
 * _coder_XyloStoriesFilter_01_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "XyloStoriesFilter_01",              /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void XyloStoriesFilter_01_api(const mxArray * const prhs[1], int32_T nlhs, const
  mxArray *plhs[1])
{
  ...
  out = XyloStoriesFilter_01(*inputData);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(out);
}

void XyloStoriesFilter_01_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  XyloStoriesFilter_01_xil_terminate();
}

void XyloStoriesFilter_01_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_XyloStoriesFilter_01_api.c) */
