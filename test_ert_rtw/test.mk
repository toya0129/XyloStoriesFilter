...
## 
## Makefile     : test.mk
## Generated on : Tue Nov 20 18:49:15 2018
##  version:  
## 
## Build Info:
## 
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/toya/Project/XyloStories/MatlabSensor
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
# Toolchain Name:          Arduino AVR v1.8.1 | gmake (64-bit Mac)
# Supported Version(s):    
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/toya/MATLAB/SupportPackage/toolbox/target/shared/svd/include -I/Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/test_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -I/Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinotarget/include -I/Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -I/Users/toya/MATLAB/SupportPackage/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_STANDARD = -DMODEL=test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : /Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : /Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : /Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
MW_ArduinoHWInit.o : /Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


arduinoAVRScheduler.o : /Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


ext_svr_daemon.o : /Users/toya/MATLAB/SupportPackage/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c
	$(CC) $(CFLAGS) -o $@ $<


rtiostream_serial_daemon.o : /Users/toya/MATLAB/SupportPackage/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


daemon_checksum.o : /Users/toya/MATLAB/SupportPackage/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
	$(CC) $(CFLAGS) -o $@ $<
